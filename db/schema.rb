...
ActiveRecord::Schema.define(:version => 20130719083345) do
  ...
  create_table "screencasts", :force => true do |t|
    ...
    t.datetime "created_at",                            :null => false
    t.datetime "updated_at",                            :null => false
    t.string   "episode_file_name"
    t.string   "episode_content_type"
    t.integer  "episode_file_size"
    t.datetime "episode_updated_at"
